...
echo "<tr>";
echo "<td >".'Telefon: '.$c['telefon']."</td>";
echo "<td >".'Ulica: '.$c['ulica']."</td>";
echo "<td >".'Nr domu: '.$c['nr_domu']."</td>";
echo "<td >".'Nr mieszkania: '.$c['nr_mieszkania']."</td>";
echo "</tr>";
echo "</table>";
...
echo "<tr>";
echo "<td >".'Pizza: '.$r['pizza']."</td>";
echo "<td >".'Rozmiar: '.$r['rozmiar']."</td>";
echo "<td >".'Ilość: '.$r['ilosc']."</td>";
